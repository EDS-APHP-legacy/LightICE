...
public interface DeviceClock {
    ...
    class WallClock implements DeviceClock {
    ...
    class Metronome extends WallClock {
    ...
    class ReadingImpl implements DeviceClock.Reading {
    ...
    class CombinedReading implements DeviceClock.Reading {
